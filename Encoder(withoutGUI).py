...
def main():
    ...
    image_out.putdata(NewImagePixelsAllDecimal)
    NewImageName = 'StegoCat.png'
    image_out.save(NewImageName)
    print("The image " + NewImageName + " is has been created with the hidden message. Encoding is done!")
